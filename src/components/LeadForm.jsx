  ...
  return (
    <div className="flex flex-col gap-4 py-[5rem] px-5 bg-primary/5">
      ...
      <p data-aos="fade-up" className="desc text-center max-w-[55rem] mx-auto">
        We’d love to hear about your ideas, challenges, or even just where
        you’re stuck. Reach out to us — no pressure, no pushy sales pitch — just
        real people who get tech and care about your success.
      </p>
      <form
