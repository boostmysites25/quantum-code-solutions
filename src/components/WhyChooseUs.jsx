...
const content = [
  {
    icon: icon5,
    title: "Creativity",
    desc: "We imagine boldly and challenge the norm, delivering work that’s anything but ordinary.",
  },
  {
    icon: icon2,
    title: "Collaboration",
    desc: "We harness the power of diverse minds, believing great things happen when we create together.",
  },
  {
    icon: icon1,
    title: "Impact",
    desc: "We aim to inspire change and craft brands that leave a lasting impression.",
  },
  {
    icon: icon8,
    title: "Innovation",
    desc: "We lead with curiosity, adopting cutting-edge tech and trends to keep your brand ahead.",
  },
];
        ...
        >
          ...
          <div className="py-[3rem] px-5 bg-white/10 rounded-xl backdrop-blur-sm text-primary_text relative z-10">
            ...
            <h2 className="sub-heading text-center max-w-[60rem] mt-3 mx-auto">
              At Quantum Code Solutions, we believe in the power of:
            </h2>
            <div
              data-aos="fade-up"
