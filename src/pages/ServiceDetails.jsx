    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary/5 via-background to-secondary/5 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-primary/20 to-secondary/20 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-secondary/10 to-primary/10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="wrapper py-[4rem] md:py-[6rem] relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h2
                className="heading-2 mb-6 px-4 lg:px-0"
                data-aos="fade-up"
                data-aos-delay="100"
              >
              ...
              <p
                className="text-lg text-gray-600 mb-8 px-4 lg:px-0 leading-relaxed"
                data-aos="fade-up"
                data-aos-delay="150"
              >
                {service.description}
              ...
              <div
                className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 px-4 lg:px-0"
                data-aos="fade-up"
                data-aos-delay="200"
              >
                <Link
                  to="/contact-us"
                  className="group relative overflow-hidden bg-gradient-to-r from-secondary to-primary text-white font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300"
                >
                ...
                {service.link && (
                  <Link
                    to={service.link}
                    className="group relative overflow-hidden bg-white border-2 border-secondary text-secondary font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 hover:bg-secondary hover:text-white"
                  >
            ...
            <div className="relative" data-aos="fade-left" data-aos-delay="300">
              <div className="relative group">
                ...
                <div
                  className="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-r from-primary to-secondary rounded-full animate-bounce"
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute top-3/4 right-1/4 w-3 h-3 bg-secondary/50 rounded-full animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute top-1/2 left-3/4 w-1 h-1 bg-white/40 rounded-full animate-ping"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute bottom-1/4 left-1/2 w-2 h-2 bg-secondary/40 rounded-full animate-pulse"
            style={{ animationDelay: "0.5s" }}
          ></div>
        </div>
        ...
        {/* Geometric Shapes */}
        <div
          className="absolute top-10 right-10 w-20 h-20 border border-white/20 rotate-45 animate-spin"
        ...
        <div className="wrapper py-[5rem] md:py-[7rem] text-center relative z-10">
          ...
          <h2
            className="text-3xl md:text-5xl font-bold mb-6 px-4 text-white"
            data-aos="fade-up"
          >
          ...
          >
            <p className="text-lg md:text-xl text-white/90 leading-relaxed">
              ...
              services can help drive your business forward with innovative
      ...
      <section className="bg-gradient-to-b from-background via-secondary/5 to-primary/5 relative overflow-hidden">
        ...
        <div className="wrapper py-[5rem] md:py-[7rem] relative z-10">
          ...
          <div className="text-center flex flex-col items-center mb-16 md:mb-20 px-4">
            <div
              className="inline-flex items-center gap-3 bg-gradient-to-r from-secondary/10 to-primary/10 px-6 py-3 rounded-full border border-secondary/20 mb-6"
              data-aos="fade-up"
            >
              <div className="w-2 h-2 bg-gradient-to-r from-secondary to-primary rounded-full animate-pulse"></div>
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Discover more ways we can help transform your business with our
              comprehensive range of cutting-edge digital solutions.
            </p>
          </div>
